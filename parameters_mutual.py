...
def args_parser(jupyter_notebook):
    ...
    parser.add_argument('--beta', type=int, default= 0.005, help="MI coefficient")
    ...
    parser.add_argument('--totalbatch', type=int, default=2010, help="number of total batches to train")
